...
<div class="container mt-2">
    <div class="row">
        <div class="col-lg-12 margin-tb">#272627
            <div class="pull-left mb-2">
                <h2 style="color: whitesmoke; margin-top: 30px; font-weight: bolder;"><span style="color: #17468b; font-weight: bolder;">Project</span> toevoegen</h2>
            </div>
    ...
    <form action="{{ route('projecten.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Titel</strong>
                    <input style="background-color: #272627; border: 1px solid #272627;" type="text" name="title" class="form-control">
                    @error('title')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
